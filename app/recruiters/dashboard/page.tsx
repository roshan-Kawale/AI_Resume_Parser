...
import { BriefcaseIcon, UserIcon, SearchIcon, PlusIcon, StarIcon } from "lucide-react";
import type { Candidate, CandidateWithAiEvaluation, JobDescription } from "@/app/types";
import { ScrollArea } from "@/components/ui/scroll-area";
import { ToastContainer, toast } from "react-toastify";
import { CandidateTableSkeleton } from "./candidateTableSkeleton";

export default function DashboardPage() {
  const [candidates, setCandidates] = useState<CandidateWithAiEvaluation[]>([]);
          ...
          <TabsContent value="candidates">
            <Card className="p-6">
              <Table>
                ...
                { isLoading ? <CandidateTableSkeleton/> : 
                  <TableBody>
